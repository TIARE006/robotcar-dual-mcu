...
#define      macESP8266_USART_TX_GPIO_CLK()                    __HAL_RCC_GPIOA_CLK_ENABLE()  
#define      macESP8266_USART_TX_PORT                         GPIOA   
#define      macESP8266_USART_TX_PIN                          GPIO_PIN_2
#define      macESP8266_USART_TX_AF                           GPIO_AF7_USART2
...
#define      macESP8266_USART_RX_AF                           GPIO_AF7_USART2
...
#define     macPC_Usart( fmt, ... )                do { (void)0; } while (0)    
