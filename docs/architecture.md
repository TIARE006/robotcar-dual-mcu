...
`firmware/h750_wifi_bridge` is a communication bridge. It owns WiFi association through ESP-12F, TCP server handling, and forwarding received lines to the F407 over USART1.
